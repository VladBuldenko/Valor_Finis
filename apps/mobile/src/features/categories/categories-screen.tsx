...
// Read-only category management list (VF-009B). Create/Edit/Delete/Hide are
// intentionally out of scope for this slice -- this screen only displays the
// authenticated user's categories, including hidden ones.
